...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    # SwayNC style with Rose Pine colors
    xdg.configFile."swaync/style.css".text = ''
      @define-color background ${colors.hex.base};
      @define-color text ${colors.hex.text};
      @define-color mycolor ${colors.hex.love};
      @define-color color4 ${colors.hex.foam};
      @define-color color7 ${colors.hex.text};
      @define-color color9 ${colors.hex.love};
      @define-color color15 ${colors.hex.text};
